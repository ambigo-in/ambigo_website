...
const ParamedicalTrainerForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const body = `Name=${encodeURIComponent(formData.fullName)}&Email=${encodeURIComponent(formData.email)}&MobileNumber=${encodeURIComponent(formData.phone)}&Experience=${encodeURIComponent(formData.experience)}&Certifications=${encodeURIComponent(formData.certifications)}&bot_field=${encodeURIComponent(formData.bot_field)}&TimeStamp=${encodeURIComponent(timestamp)}`;
      ...
      setSuccess(true);
      setFormData({ fullName: '', email: '', phone: '', experience: '', certifications: '', bot_field: '' });
